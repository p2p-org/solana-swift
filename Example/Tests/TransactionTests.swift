...
class TransactionTests: XCTestCase {
    ...
    func testSerializeMessage() throws {
        ...
        message.feePayer = try SolanaSDK.Account(secretKey: Data(Base58.decode("4Z7cXSyeFR8wNGMVXUE1TwtKn5D5Vu7FzEv69dokLv7KrQk7h6pu4LF8ZRR9yQBhc7uSM6RTTZtU1fmaxiNrxXrs")))
    ...
    func testSignAndSerializeTransfer() throws {
        ...
        transaction.message.add(instruction: SolanaSDK.SystemProgram.transferInstruction(from: fromPublicKey, to: toPublicKey, lamports: lamports))
