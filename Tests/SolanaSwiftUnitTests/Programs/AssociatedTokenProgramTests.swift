...
class AssociatedTokenProgramTests: XCTestCase {
    ...
    func testCreateAssociatedTokenAccountInstruction() throws {
        ...
        XCTAssertEqual(instruction.keys[3], .readonly(publicKey: "EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v", isSigner: false))
        XCTAssertEqual(instruction.keys[4], .readonly(publicKey: "11111111111111111111111111111111", isSigner: false))
        XCTAssertEqual(instruction.keys[5], .readonly(publicKey: "TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA", isSigner: false))
        XCTAssertEqual(instruction.keys[6], .readonly(publicKey: "SysvarRent111111111111111111111111111111111", isSigner: false))
