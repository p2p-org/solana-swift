...
//            guard let string = string, string.utf8.count >= SolanaSDK_Depricated.PublicKey.numberOfBytes
//                else {
...
//            guard data.count <= SolanaSDK_Depricated.PublicKey.numberOfBytes else {
//                throw Error.other("Invalid public key input")
//            }
