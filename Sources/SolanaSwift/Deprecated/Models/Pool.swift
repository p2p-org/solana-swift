...
extension Array where Element == SolanaSDK_Deprecated.Pool {
    public func getMatchedPools(sourceMint: String?, destinationMint: String?) -> [SolanaSDK_Deprecated.Pool] {
        filter {
    ...
    public func getPools(mintA: String) -> [SolanaSDK_Deprecated.Pool] {
        filter {
    ...
    public func getPools(mintB: String) -> [SolanaSDK_Deprecated.Pool] {
        filter {
