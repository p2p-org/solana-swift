...
extension TokenSwapInfo: BorshCodable {
    ...
    public init(from reader: inout BinaryReader) throws {
        ...
        nonce = try .init(from: &reader)
        tokenProgramId = try PublicKey(from: &reader)
        tokenAccountA = try PublicKey(from: &reader)
        tokenAccountB = try PublicKey(from: &reader)
        tokenPool = try PublicKey(from: &reader)
        mintA = try PublicKey(from: &reader)
        mintB = try PublicKey(from: &reader)
        feeAccount = try PublicKey(from: &reader)
        tradeFeeNumerator = try .init(from: &reader)
        tradeFeeDenominator = try .init(from: &reader)
        ownerTradeFeeNumerator = try .init(from: &reader)
        ownerTradeFeeDenominator = try .init(from: &reader)
        ownerWithdrawFeeNumerator = try .init(from: &reader)
        ownerWithdrawFeeDenominator = try .init(from: &reader)
        hostFeeNumerator = try .init(from: &reader)
        hostFeeDenominator = try .init(from: &reader)
        curveType = try .init(from: &reader)
        payer = try PublicKey(from: &reader)
    }
}
