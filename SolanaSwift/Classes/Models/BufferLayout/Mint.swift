...
extension SolanaSDK {
    public struct Mint2: BufferLayout, Equatable, Hashable, Encodable {
        ...
        public static func injectOtherProperties(typeInfo: TypeInfo, currentInstance: inout SolanaSDK.Mint2) throws {
