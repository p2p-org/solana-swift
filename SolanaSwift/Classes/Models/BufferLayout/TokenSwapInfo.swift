    ...
    public struct TokenSwapInfo: BufferLayout2, Equatable, Hashable, Encodable {
        ...
        public static func layout()  -> [(key: String?, length: Int)] {
            [
                ...
                (key: "nonce", length: 1),
                (key: "tokenProgramId", length: PublicKey.numberOfBytes),
                (key: "tokenAccountA", length: PublicKey.numberOfBytes),
                (key: "tokenAccountB", length: PublicKey.numberOfBytes),
                (key: "tokenPool", length: PublicKey.numberOfBytes),
                (key: "mintA", length: PublicKey.numberOfBytes),
                (key: "mintB", length: PublicKey.numberOfBytes),
                (key: "feeAccount", length: PublicKey.numberOfBytes),
                ...
                (key: "payer", length: PublicKey.numberOfBytes),
            ]
        }
    }
}
